...
const Impressum = () => {
  ...
  return (
    <Layout>
      <SEO title="Impressum | Conrady Gartengestaltung" desc="Impressum | Conrady Gartengestaltung" />
      <AnimatedBox style={pageAnimation} py={[6, 6, 6, 8]} px={[6, 6, 8, 6, 8, 13]}>
      <p>Adrian Conrady<br />(Garten- Landschaftsbauer)</p>
      <p>Rheingaustr. 98<br />
      65719 Hofheim am Taunus</p>
      <p>Telefon: 0176/82148436</p>
      <p>Email: Conrady@gartenbauhofheim.de</p>
